...
class Firebase
{
     ...
     * @return Firebase
     */
    public function withDatabaseUri($databaseUri)
    {
     ...
     * @return Firebase
     */
    public function asUserWithClaims(string $uid, array $claims = [])
    {
    ...
    private function withCustomAuth(Auth $override)
    {
    ...
    private function createDatabaseClient(UriInterface $databaseUri)
    {
